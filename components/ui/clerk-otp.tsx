        ...
        <div className="flex w-full items-center justify-center gap-3">
          {digits.map((digit, idx) => (
            <div
              key={idx}
              className={cn(
                "text-primary relative flex h-10 w-8 cursor-default items-center justify-center rounded-md bg-gradient-to-br from-background to-muted",
                "shadow-[0_3px_10px_rgb(0,0,0,0.2)]"
              )}
            >
              {(!whileHover || (whileHover && isCardHovered)) && (
                <motion.div
                  ...
                  style={{
                    boxShadow: "inset 0 0 12px oklch(from var(--primary) l c h / 0.5)",
                  }}
                />
              )}
              {activeIndex === idx &&
                (!whileHover || (whileHover && isCardHovered)) && (
                  <motion.div
                    ...
                    style={{
                      boxShadow: "inset 0 0 12px oklch(from var(--primary) l c h / 0.6)",
                    }}
                  >
                    <svg
                      viewBox="0 0 20 20"
