...
export const Compare = ({
  ...
  const handleMouseMove = useCallback(() => handleMove(0), [handleMove]);
    ...
    >
      <AnimatePresence initial={false}>
        ...
        >
          ...
          {showHandlebar && (
            <div className="h-5 w-5 rounded-md top-1/2 -translate-y-1/2 bg-foreground z-30 -right-2.5 absolute flex items-center justify-center shadow-[0px_-1px_0px_0px_hsl(var(--primary)/0.7)] dark:shadow-[0px_-1px_0px_0px_hsl(var(--primary)/0.9)]">
