...
const DatabaseWithRestApi = ({
  ...
  // Get theme color from CSS variable and convert to hex
  ...
  const primaryColorValue = mounted ? getThemeColor('--primary') : '';
  const primaryColor = lightColor || (primaryColorValue || '#00A6F5');
    ...
    >
        ...
        <g stroke="currentColor" fill="none" strokeWidth="0.4">
          ...
          <g>
            <rect
              ...
              style={{ fill: '#18181B' }}
            ></rect>
            <DatabaseIcon x="18" y="7.5" fillColor="#ffffff"></DatabaseIcon>
            <text
              x="28"
              y="12"
              fill="#ffffff"
          ...
          <g>
            <rect
              ...
              style={{ fill: '#18181B' }}
            ></rect>
            <DatabaseIcon x="64" y="7.5" fillColor="#ffffff"></DatabaseIcon>
            <text
              x="74"
              y="12"
              fill="#ffffff"
          ...
          <g>
            <rect
              ...
              style={{ fill: '#18181B' }}
            ></rect>
            <DatabaseIcon x="112" y="7.5" fillColor="#ffffff"></DatabaseIcon>
            <text
              x="122"
              y="12"
              fill="#ffffff"
          ...
          <g>
            <rect
              ...
              style={{ fill: '#18181B' }}
            ></rect>
            <DatabaseIcon x="154" y="7.5" fillColor="#ffffff"></DatabaseIcon>
            <text
              x="165"
              y="12"
              fill="#ffffff"
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        <div className="absolute -top-3 z-20 flex items-center justify-center rounded-lg border bg-card px-2 py-1 sm:-top-4 sm:py-1.5">
          ...
          <span className="ml-2 text-[10px] text-card-foreground">
            {title ? title : "Data exchange using a customized REST API"}
          </span>
        </div>
        {/* box outter circle */}
        <div className="absolute -bottom-8 z-30 grid h-[60px] w-[60px] place-items-center rounded-full border-t bg-card font-semibold text-xs text-card-foreground">
        ...
        <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
          {/* Badges */}
          <div className="absolute bottom-8 left-12 z-10 h-7 rounded-full bg-card px-3 text-xs border flex items-center gap-2 text-card-foreground">
            <HeartHandshakeIcon className="size-4" />
            <span>{buttonTexts?.first || "LegionDev"}</span>
          </div>
          <div className="absolute right-16 z-10 hidden h-7 rounded-full bg-card px-3 text-xs sm:flex border items-center gap-2 text-card-foreground">
...
const DatabaseIcon = ({ x = "0", y = "0", fillColor = "white" }: { x: string; y: string; fillColor?: string }) => {
  return (
    <svg
      x={x}
      y={y}
