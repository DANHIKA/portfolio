  ...
  return (
    <>
      <style jsx>{`
        ...
        .shiny-cta,
        .shiny-cta-link {
          --shiny-cta-bg: oklch(from var(--background) l c h);
          --shiny-cta-bg-subtle: oklch(from var(--muted) l c h);
          --shiny-cta-fg: oklch(from var(--foreground) l c h);
          --shiny-cta-highlight: oklch(from var(--primary) l c h);
          --shiny-cta-highlight-subtle: oklch(from var(--primary) l c h / 0.8);
          ...
          line-height: 1.2;
          font-weight: 500;
          border: 1px solid oklch(from var(--shiny-cta-fg) l c h);
          ...
          background:
            ...
            conic-gradient(
              ...
              border-box;
          box-shadow: 0 0 0 1px oklch(from var(--shiny-cta-fg) l c h);
